...
class CptSousCentreDepense
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="centre_depense_code", type="string", length=15, nullable=true)
     */
    private $centreDepenseCode;
    ...
    public function getCentreDepenseCode(): ?string
    {
        return $this->centreDepenseCode;
    }

    public function setCentreDepenseCode(?string $centreDepenseCode): self
    {
        $this->centreDepenseCode = $centreDepenseCode;
